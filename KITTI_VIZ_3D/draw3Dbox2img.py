...
for img_id in range(500):
    ...
    calib = Calibration('/home/chang0731/Desktop/elan_project/monodle/data/KITTI/object/testvideo2/calib/%06d.txt'%img_id)
    #path_img = '/home1/yang_ye/data/Kitti/testing/image_2/%06d.png'%img_id
    path_img='/home/chang0731/Desktop/elan_project/monodle/data/KITTI/object/testvideo2/data/%010d.png'%img_id

    #df = read_detection('/home2/yang_ye/wei3/%06d.txt'%img_id)
    df =read_detection('/home/chang0731/Desktop/elan_project/monodle/experiments/example/outputs_video3/data/%06d.txt'%img_id) 
    ...
    cv2.imwrite(dir_name+str(img_id)+'.png' , image)
